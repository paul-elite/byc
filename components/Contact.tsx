    ...
    <section id="contact" className="py-24 md:py-32 bg-gradient-to-b from-white to-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-5 py-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-all duration-200 text-gray-900 placeholder:text-gray-400 text-base"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    rows={8}
                                    className="w-full px-5 py-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-all duration-200 resize-none text-gray-900 placeholder:text-gray-400 text-base"
                            ...
                            <button
                                ...
                                className={`w-full px-6 py-5 bg-primary-600 text-white font-semibold rounded-xl hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-all duration-200 ${
                            ...
                            {submitStatus === 'success' && (
                                <div className="flex items-start p-5 bg-green-50 border border-green-200 rounded-lg text-green-800 animate-fadeIn">
                    ...
                    {/* Contact Info */}
                    <div className="animate-slideInRight space-y-10">
                        <div>
                        ...
                        {/* Business Hours Card */}
                        <div className="bg-gradient-to-br from-primary-50 to-primary-100/50 p-8 rounded-xl border border-primary-200/50">
