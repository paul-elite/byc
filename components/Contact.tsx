                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="bg-primary-600 text-white p-6 rounded-2xl">
                            ...
                            <div className="space-y-4">
                                ...
                                <a href="mailto:info@byc.com.ng" className="flex items-center gap-3 hover:text-primary-200 transition-colors">
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                    info@byc.com.ng
                                </a>
                                <a href="https://byc.com.ng" className="flex items-center gap-3 hover:text-primary-200 transition-colors">
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="bg-gray-50 p-6 rounded-2xl">
                            ...
                            <div className="space-y-2 text-sm text-gray-600">
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium text-gray-900">BN 2861419</span>
                                </div>
                                <div className="flex justify-between">
                                    <span>Practicing License</span>
                                    <span className="font-medium text-gray-900">050839</span>
                                </div>
                                <div className="flex justify-between">
                                    <span>FRCN Number</span>
                                    <span className="font-medium text-gray-900">FRC/2019/CITN/...</span>
                                </div>
                            </div>
                        </div>
                    </div>
